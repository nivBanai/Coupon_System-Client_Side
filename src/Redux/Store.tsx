...
const reducers = combineReducers({ userReducer: userReducer, adminReducer: adminReducer, companyReducer: companyReducer, customerReducer: customerReducer, couponReducer: couponReducer});
